/*ident	"@(#)cls4:incl-master/const-headers/vector.h	1.2" */
/*******************************************************************************
...
class stack(type) : private vector(type) {						\
	int t;									\
public:										\
	stack(type)(int s) : vector(type)(s) { t = 0; }					\
	stack(type)(stack(type)& a) : vector(type)((vector(type)&)a) { t = a.t; }		\
	void push(type& a)							\
