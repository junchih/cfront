...
#pragma ident	"@(#)curses.ed	1.9	92/07/14 SMI"	/* SVr4.0 1.58	*/
...
extern	int	pair_content(int, short *, short *),	/* int sb. short */
		color_content(int, short *, short *, short *), /* as above */
		init_color(int, int, int, int),		 /* all 4 ints */
		init_pair(int, int, int),		 /* all 3 ints */
		idlok(WINDOW *, int);			 /* int sb. bool */

extern	void	immedok(WINDOW *, int);			 /* int sb. bool */
...
extern int	addch(chtype), addchnstr(chtype *, int), addchstr(chtype *),
		...
		clear(void), clearok(WINDOW *, int),	 /* int sb. bool */
...
/* MORE */	fixterm(void),
		...
		leaveok(WINDOW *, int),			 /* int sb. bool */
		meta(WINDOW *, int),
		...
		nl(void), nocrmode(void),
		nodelay(WINDOW *, int),			 /* int sb. bool */
		noecho(void), nonl(void),
		notimeout(WINDOW *, int),		 /* int sb. bool */
...
extern	void	bkgdset(chtype), idcok(WINDOW *, int),	/* int sb. bool */
		noqiflush(void),
		wbkgdset(WINDOW *, chtype),
		qiflush(void), timeout(int), wtimeout(WINDOW *, int),
		use_env(int);				 /* int sb. char */
...
extern	void	wbkgdset(WINDOW *, chtype),
		idcok(WINDOW *, int),		 /* int sb. bool */
		wtimeout(WINDOW *, int),
		use_env(int);			 /* int sb. char */

extern	int	syncok(WINDOW *, int),		/* int sb. bool */
		notimeout(WINDOW *, int),	/* int sb. bool */
		clearok(WINDOW *, int),		/* int sb. bool */
		leaveok(WINDOW *, int),		/* int sb. bool */
		scrollok(WINDOW *, int),	/* int sb. bool */
		nodelay(WINDOW *, int),		/* int sb. bool */
		is_linetouched(WINDOW *, int), is_wintouched(WINDOW *),
